    ...
    <section class="appendix-section" id="app:cases">
      ...
      <div class="gallery-callout-panel">
        ...
        <div style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-top: 0.75rem;">
          ...
          <a href="https://github.com/MIT-CDFG/Survey-AI-for-3D-modeling-Robotics" target="_blank" rel="noopener noreferrer" class="btn-callout-switch" style="background: transparent; color: var(--ink-primary); border: 1px solid var(--border-line); text-decoration: none;">
  ...
  <main class="page-body">
    ...
    <section id="view-html" class="view-panel active">
      ...
      <header class="academic-header">
        ...
        <div class="action-pills-row">
          <a href="https://github.com/MIT-CDFG/Survey-AI-for-3D-modeling-Robotics" target="_blank" rel="noopener noreferrer" class="pill-btn github-btn" title="Open Repository on GitHub">
            <svg height="15" width="15" viewBox="0 0 16 16" fill="currentColor"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"></path></svg>
    ...
    <section id="view-gallery" class="view-panel">
      <div class="gallery-page-layout">
        ...
        <p class="panel-section-desc">
          A systematic visual registry compiling all {total_count} multi-domain generation showcases documented across the survey appendix. The underlying dataset and raw demonstration media are actively maintained in the open-source repository: <a href="https://github.com/MIT-CDFG/Survey-AI-for-3D-modeling-Robotics" target="_blank" rel="noopener noreferrer" style="color: var(--mit-red); font-weight: 600; text-decoration: underline;">MIT-CDFG/Survey-AI-for-3D-modeling-Robotics ↗</a>.
        </p>
  ...
  note={{Working draft, living survey}}
    ...
    <footer class="academic-footer">
      ...
      <p style="margin-top: 0.4rem;">
        ...
        <a href="https://github.com/MIT-CDFG/Survey-AI-for-3D-modeling-Robotics" target="_blank" rel="noopener noreferrer">GitHub Repository</a> · 
        {footer_pdf_link}
