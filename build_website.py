...
LABEL_DATA = {
    ...
    "sec:related": ("Section", "2"),
    "sec:intro-related": ("Section", "2"),
    "sec:related-3d": ("Section", "2.1"),
    "sec:related-cad": ("Section", "2.2"),
    "sec:related-sim": ("Section", "2.3"),
    "sec:related-anim": ("Section", "2.4"),
    "sec:related-robot-planning": ("Section", "2.5"),
    "sec:related-robot-learning": ("Section", "2.6"),
    "sec:related-foundations": ("Section", "2.7"),
    "sec:technology": ("Section", "3"),
    "sec:tech-applications": ("Section", "3.1"),
    "sec:tech-computer-use": ("Section", "3.1"),
    "sec:tech-robot-interfaces": ("Section", "3.2"),
    "sec:tech-icl": ("Section", "3.3"),
    "sec:tech-regimes": ("Section", "3.4"),
    "sec:capabilities": ("Section", "4"),
    "sec:cap-3d": ("Section", "4.1"),
    "sec:cap-cad": ("Section", "4.2"),
    "sec:cap-robot": ("Section", "4.3"),
    "sec:cap-animation": ("Section", "4.4"),
    "sec:evaluation": ("Section", "5"),
    "sec:eval-3d": ("Section", "5.1"),
    "sec:eval-robot": ("Section", "5.2"),
    "sec:eval-demonstrations": ("Section", "5.3"),
    "sec:eval-generations": ("Section", "5.4"),
    "sec:eval-field": ("Section", "5.5"),
    "sec:eval-attribution": ("Section", "5.6"),
    "sec:opportunities": ("Section", "6"),
    "sec:opp-artifacts": ("Section", "6.1"),
    "sec:opp-realtosim": ("Section", "6.2"),
    "sec:opp-offline": ("Section", "6.3"),
    "sec:opp-evaluation": ("Section", "6.4"),
    "sec:opp-access": ("Section", "6.5"),
    "sec:risks": ("Section", "7"),
    "sec:risk-reliability": ("Section", "7.1"),
    "sec:risk-speed": ("Section", "7.2"),
    "sec:risk-engineering": ("Section", "7.3"),
    "sec:risk-safety": ("Section", "7.4"),
    "sec:risk-provenance": ("Section", "7.5"),
    "sec:risk-ethics": ("Section", "7.6"),
    "sec:risk-assessment": ("Section", "7.7"),
    "sec:recommendations": ("Section", "8"),
    "sec:conclusion": ("Section", "9"),
    "sec:intro-scope": ("Section", "10"),
    "sec:intro-methods": ("Section", "10"),
